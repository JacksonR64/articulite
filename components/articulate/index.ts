/**
 * Articulate Component Exports
 *
 * This file exports all Articulate-specific components to enable clean imports:
 * import { QuestionCard, Timer, TeamDisplay } from '@/components/articulate';
 */
